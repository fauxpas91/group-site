...
If you are somewhat familiar with Git and Github then I suggest you plough on. Here is a condensed guide, with some instructions particular to this project, but you should refer to the resources and should follow them in preference to my musings below when detail is important __and detail is always important:__
 ...
 - Once the site is completely developrd, the Site development roles page can then be stripped out or possibly morphed to a Members Profile page if the finished site is published to the great www. How it can be hosted, at zero cost, I have no idea at this stage.
 - Now, I suggest you read the reference below GitHub Standard Fork & Pull Request Workflow and take note of the content and work through the steps carefully.
...
## Using Github issues
It might be a good idea to communicate any problems, new feature requests, etc. using Github issues. Sign into your Github account and navigate to this repo and click the New Issue button.
...
I just hope Reading freeCodeCampers can recognize an opportunity when they see one. I've done the inception phase. I leave the testing through to deployment to the group.
